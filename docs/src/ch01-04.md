...
```shell
$ docker pull docker.educg.net/cg/os-contest:20250214

# 创建一个未链接网络的容器
$ docker create --privileged --network=none -w /work  -v $(pwd):/work docker.educg.net/cg/os-contest:20250214 sleep inf

$ docker start febd9d7e7088
$ docker docker exec -it febd9d7e7088 bash
